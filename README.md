...
I created this addon to restore pinned tabs functionality from Arc Browser to Helium. The plugin should also work in other Chromium browsers.
...
## Installation [EN]
1. Download `PinToAllW-1.4.zip` from [releases](https://github.com/retronprod/Pin-To-All-Windows-addon/releases)
...
1. Pobierz `PinToAllW-1.4.zip` z [releases](https://github.com/retronprod/Pin-To-All-Windows-addon/releases)
